  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6">
        <h1 className="text-display text-3xl sm:text-4xl lg:text-5xl">{t("centers.title")}</h1>
        ...
        <div className="mt-8 rounded-2xl border border-border bg-card p-4 shadow-soft">
          ...
          <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:items-center">
            <select
              ...
              className="w-full sm:w-36 rounded-md border border-input bg-input px-3 py-2 text-sm"
            >
            ...
            <select
              ...
              className="w-full sm:w-44 rounded-md border border-input bg-input px-3 py-2 text-sm"
            >
            ...
            <select
              ...
              className="w-full sm:w-40 rounded-md border border-input bg-input px-3 py-2 text-sm"
            >
